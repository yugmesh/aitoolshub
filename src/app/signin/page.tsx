...
export default function SignInPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    alert("Authentication coming soon! This is a placeholder sign-in page.");
  }
    ...
    <div className="min-h-screen bg-[#070709] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="font-extrabold text-2xl text-white mb-1">Welcome back</h1>
          <p className="text-zinc-400 text-sm">Sign in to your account</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-[#0d0d14] border border-white/[0.07] rounded-2xl p-6 flex flex-col gap-4">
          <div>
